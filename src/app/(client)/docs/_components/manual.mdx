  ...
  <table className="min-w-full border-collapse border border-gray-300">
    ...
    <tbody>
      <tr>
        ...
        <td className="border border-gray-300 px-4 py-2"><strong>Required.</strong> Your Account ID</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2">x-project-id</td>
        <td className="border border-gray-300 px-4 py-2">string</td>
        <td className="border border-gray-300 px-4 py-2"><strong>Required.</strong> Your Project ID</td>
      </tr>
    </tbody>
  </table>
</div>
  ...
  <table className="min-w-full border-collapse border border-gray-300">
    ...
    <tbody>
      <tr>
        ...
        <td className="border border-gray-300 px-4 py-2"><strong>Required</strong>. Email address of the feedback sender</td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2">type</td>
        <td className="border border-gray-300 px-4 py-2"><code className="bg-gray-100 rounded px-1">string</code></td>
        <td className="border border-gray-300 px-4 py-2"> <strong>Required</strong>. Type of feedback: <strong>bug</strong> or <strong>feature</strong> or <strong>message</strong> </td>
      </tr>
      <tr>
        <td className="border border-gray-300 px-4 py-2">feedback</td>
        <td className="border border-gray-300 px-4 py-2"><code className="bg-gray-100 rounded px-1">string</code></td>
        <td className="border border-gray-300 px-4 py-2"><strong>Required</strong>. Content of the feedback message</td>
      </tr>
    </tbody>
  </table>
</div>
...
## Code Example
 ...
 <FeedbackPost copyable showLineNumbers filename='feedback.js' className='w-full bg-white' />