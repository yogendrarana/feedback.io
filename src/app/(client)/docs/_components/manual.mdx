...
<div className="mt-2 flex gap-4 flex-col md:flex-row md:justify-between">
  <CodeBlock filename="using-axios.js" copyable className="flex-1">
    ```javascript
  ...
  <CodeBlock filename="using-fetch.js" copyable className="flex-1">
    ```javascript
