  ...
  <table className="min-w-full border-collapse border border-gray-300">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td className="border border-gray-300 px-4 py-2"><code className="bg-gray-100 rounded px-1">string</code></td>
        <td className="border border-gray-300 px-4 py-2"> <strong className='dark:text-white'>Required</strong>. Type of feedback: <strong className='dark:text-white'>bug</strong> or <strong className='dark:text-white'>feature</strong> or <strong className='dark:text-white'>message</strong> </td>
      </tr>
      <tr>
